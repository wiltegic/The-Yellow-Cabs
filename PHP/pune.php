            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Pune City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">The thriving metropolis, Pune stores many tourist places that often entice the visitors. With a splash of old world charm, Pune has a number of places of historical importance; and is also lined with other modern attractions like gardens and temples.</p> 
                        <p class="fw-light h5 mb-4">It is one of those cities that must be visited during Maharashtra tours as it perfectly reflects the state&rsquo;s diversity.</p>
                        <p class="fw-light h5 mb-4">This is the second largest city in Maharashtra. Also known as the &ldquo;Queen of Deccan&rdquo;, this hilly city has a royal history of being home to the Rahstrakuta Dynasty taken over and ruled by the mighty Chhatrapati Shivaji.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Pune :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit the Classic Monument - Shaniwar Wada.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Do visit to vitness the Beauty of Aga Khan Palace.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Live the Nightlife of Pune in Cafes &amp; Nightclubs.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿  Visit Joshi&apos;s Museum of Miniature Railways.<br></p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Explore the Pataleshwar Cave Temple.</p> 
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
