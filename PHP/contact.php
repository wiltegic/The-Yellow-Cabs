...
<html lang="en"> 
    ...
    <body class="main-layout"> 
        ...
        <header> 
            ...
            <img src="images/palm-airport-vip-transfers.jpg" width="100%"/> 
            <section class="bg-light pb-5 pt-5"> 
                <div class="container pb-4 pt-4"> 
                    <div class="row"> 
                        <div class="col-lg-6 col-xl-6 py-3">
                            <div class="card">
                                <div class="bg-light card-header h5">1. Send us an email:</div>
                                <ul class="list-group list-group-flush ">
                                    <li class="list-group-item text-body">If you are facing any issue/ or for feedback, write to us at:
                                        <div>
                                            <a href="mailto:contact@theyellowcabs.com" class="text-primary">contact@theyellowcabs.com</a>
                                            <br>
                                            <div>
                                                <a href="mailto:support@theyellowcabs.com" class="text-primary">support@theyellowcabs.com</a>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                <div class="bg-light card-header h5">2. Pick up the phone and call us 24*7:</div>
                                <li class="list-group-item list-group-item-light">If you are facing any issue/ or for feedback, write to us at:
                                    <div>
                                        <a href="tel:+919638803666" class="text-primary">+91-9638803666</a>
                                        <br>
                                        <div>
                                            <a href="tel:+91-9638802666" class="text-primary">+91-9638802666</a>&nbsp;
                                            <div>
                                                <div>
                                                    <div>(standard STD/local charges apply)</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <div class="bg-light card-header h5">2. Our Address:</div>
                                <li class="list-group-item list-group-item-light text-body">57, shyamsundar society, near Nirman habitat,
                                    <div>b/h panchadev mahadev temple,
                                        <br>
                                        <div>karmcharinagar road, Ghotlodia, Ahmedabad</div>
                                    </div>
                                </li>
                            </div>                             
                        </div>
                        <div class="col-md-4 col-xl-6">
                            <div class="mapouter">
                                <div class="gmap_canvas">
                                    <iframe class="gmap_iframe" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=600&amp;height=500&amp;hl=en&amp;q=shyamsundar society, ghatlodia&amp;t=&amp;z=18&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
                                    <a href="https://www.fnfgo.com/">FNF</a>
                                </div>
                                <style>.mapouter { position: relative; text-align: right; width: 600px; height: 500px; } .gmap_canvas { overflow: hidden; background: none!important; width: 600px; height: 500px; } .gmap_iframe { width: 600px!important; height: 500px!important; }</style>
                            </div>                             
                        </div>                         
                    </div>                     
                </div>                 
