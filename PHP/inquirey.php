...
if(isset($_REQUEST['submit'])){
    ...
    $response= addBookingToCRM($_REQUEST, "/index.php?entryPoint=sendInquirey");
...
<html lang="en"> 
    ...
    <body class="main-layout"> 
        ...
        <img src="images/student-meeting-teacher.jpg" width="100%"/> 
        <section class="bg-light pb-5 pt-5 text-center"> 
            <div class="container pb-4 pt-4"> 
                <div class="row"> 
                    <div class="col-lg-8 ml-auto mr-auto py-3"> 
                        <h2 class="font-weight-bold text-uppercase">Inquirey</h2> 
                        <p class="mb-5 text-secondary">Enter Your Details Below</p> 
                        <form id="inquirey_form" name="inquirey_form" action="inquirey.php"> 
                            <div class="form-group"> 
                                <input type="text" class="border border-1 form-control rounded-1" placeholder="Full Name" id="name" name="name"> 
                            </div>                             
                            <div class="form-group"> 
                                <input type="tel" class="border border-1 form-control rounded-1" placeholder="Contact Number" id="mobile_number" name="mobile_number"> 
                            </div>                             
                            <div class="form-group"> 
                                <input type="email" class="border border-1 form-control rounded-1" placeholder="Email Address" id="email" name="email"> 
                            </div>                             
                            <div class="form-group"> 
                                <textarea class="border-1 form-control rounded-1" rows="6" placeholder="Enter your Inquirey..." id="inquirey" name="inquirey"></textarea> 
                            </div>                             
                            <div class="form-group"> 
</div>                             
                            <button type="submit" class="btn btn-block btn-warning rounded-1 text-body text-uppercase" id="submit" name="submit">Submit</button>                             
                        </form>                         
                    </div>                     
                </div>                 
            </div>             
