...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Jaipur Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Pink City Jaipur</b></h3> 
                        <p class="fw-light h5 mb-4">Jaipur is a place not less than a paradise. It is impossibly romantic and picturesque, decked with royal palaces atmospheric Havlies, eclectic museums, and ancient towering temples. It is more than just a city.</p> 
                        <p class="fw-light h5 mb-4">It is not wrong to say that Jaipur as a city is the soul of Indian culture. Fusion of old and modern, Chaotic yet tranquil welcoming and hospitable Jaipur is the beating heart of Rajasthan Tourism.</p>
                        <p class="fw-light h5 mb-4">Jaipur Tourism has something to offer to everyone; colourful melange of magnificent forts and palaces to feel the royal bliss; colourful bazaars and delightfully chaotic streets full of life for those who wants to explore the local life of Jaipur; wildlife and adventure activities to dance in thrill and excitement and repository of divine temples for those looking for solace and spiritual bliss.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Jaipur :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit the World UNESCO Site&nbsp;Jantar Mantar Astronomical Park.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Go visit the world famous&nbsp;Hawa Mahal of Jaipur.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit the floating mahal in lack the &quot;Jal Mahal&quot;.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Vitness the beauty of marbal architecture at&nbsp;Birla Temple.<br></p>                                      
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
