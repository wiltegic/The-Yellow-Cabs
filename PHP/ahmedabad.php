...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Ahmedabad Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Ahmedabad City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">Ahmedabad, the commercial hub of Gujarat, is the 7th biggest metropolis in India. This commercial enterprise centre of India has attracted many trendsetters and tycoons from the surprisingly aggressive discipline, which makes the town rather evolving, modern and making an investment.</p> 
                        <p class="fw-light h5 mb-4">beyond the Ahmedabad&apos;s business personality, the town also boasts a vibrant cultural scene providing the eclectic impacts of its Mughal roots, colonial connections and a pool of Gujarati human beings. also, Ahmedabad has many tourism locations to visit like Kankaria Lake, Sabarmati Ashram, Calico Museum of Textiles, Hathee Singh Temple, Sarkhej Roza, and so on.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Ahmedabad :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Try delicious Gujarati cuisine at a local food joint or restaurant. Pallet of different flavours, Gujarati thali is a must try.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Go for a heritage walk to the old city and explore the beautiful monuments.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Ahmedabad offers unparalleled venues for shopping. From Ahmedabad, one can purchase bandhani sarees, suits,dupatta and mirror work materials.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ History lovers can make their way to Sabarmati Ashram.<br></p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Go for a morning walk at the Sabarmati riverfront.</p> 
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
