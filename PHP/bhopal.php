...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Bhopal Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Bhopal City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">Renowned as the Lake City for its several natural and artificial lakes, Bhopal is the capital of the Indian state of Madhya Pradesh. It&apos;s a beautiful place that greets every tourist with its richness of tradition, which is enlaced with the modern life.</p> 
                        <p class="fw-light h5 mb-4">Situated on the place where the ancient town of Bhojapal was stood once. Discovered by Raja Bhoj, the city has two beautiful lakes that are located in the centre of the city.</p>
                        <p class="fw-light h5 mb-4">Known as one of the greenest cities in India, the city is beatified with forests, beautiful hills and awe-inspiring landscapes. It&apos;s a popular tourist destination that exhibits the real coherency of southern and northern charms.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Bhopal :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ You can visit to the 11th century Bhoj Temple that highlights the history of Raj Bhoj Empire.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit Shaukat Mahal to catch the glimpse of European architectural styles.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ If you want to travel more into history- then make an expedition to Bhimbetka, an archaeological treasure house which is located at south of Bhopal.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ The elegant Sadar Manzil- the hall of public audience of the former Nawabs of Bhopal, the Jama Masjid and the Moti Masjid in Bhopal are another major sanctified attractions in the city that flock a large number of tourists from all across the world.<br></p> 
                                    <p class="h5 mb-0 text-body text-left">⦿  While you&apos;re on a sightseeing tour, you&apos;ll come across the prime location of Shamla and Idgah hills, where a very famous Habitat Museum is located with a splendid open air exhibition of modern, life-size and tribal dwellings from all over the country.</p> 
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
