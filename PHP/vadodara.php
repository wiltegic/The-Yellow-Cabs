...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Vadodara Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    <div class="col-lg-6 me-auto pb-3 pt-3 text-center"> 
                        <img src="images/vadodara.jpg"/> 
                    </div>                     
                    <div class="col-lg-6 pb-3 pt-3"> 
                        <h2 class="h6 mb-1 text-body">Explore</h2> 
                        <h3 class="fw-bold h2 mb-1"><b>Vadodara City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">Vadodara (formerly Baroda) is the third largest city in Gujarat, located on the bank of Vishwamitri River, towards the south-east of Ahmedabad. Gigantic monuments, museums and gardens documenting the Indian history dominate the old quarter of Vadodara.</p> 
                        <p class="fw-light h5 mb-4">The tinsel town is the brainchild of Sayajirao III, a farsighted ruler who introduced free primary education and laid foundation for premier institutions like Bank of Baroda, a railway system and Maharaja Sayajirao University.</p>
                        <p class="fw-light h5 mb-4">Take a special time out to visit the well-manicured garden, Sayaji Baugh. Located in the heart of the city, the park houses a zoo, planetarium, and Vadodara Museu, which has an electric mix of Mughal miniatures, royal artefacts and European oil paintings.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Vadodara :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Do visit Fatehsingh Museum and Laxmi Vilas Palace to review the royal exhibits and notable artwork of the famous artists.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Plan a tour to Pavagadh-Champaner, a UNESCO world heritage site and a major religious landmark too.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Explore the Tribal Academy at Tejgarha, a unique academy for the study of different tribal communities.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit the majestic EME Temple or &quot;Dakshinamurty Temple&quot; and witness its unique architecture which is made by Indian Army Authorities.<br></p> 
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
