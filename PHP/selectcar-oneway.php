            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center bg-light row"> 
                    <div class="col-lg-8 me-auto pb-3 pt-3 text-left"> 
                        ...
                        <span class="h5">City 1</span> &nbsp; 
                        <span class="h5">(Outstation - Oneway)</span>
                    </div>                     
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="mt-0 text-left"><u>Extra KM Charges :</u> 9 ₹ Per KM</p>
                                        <p class="text-left"><u>Inclusion :</u>&nbsp;Driver Allowance, Toll tax , State tax </p>
                        ...
                        <div class="modal pg-show-modal fade" id="modal2">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="mt-0 text-left"><u>Extra KM Charges :</u>&nbsp;10 ₹ Per KM</p>
                                        <p class="text-left"><u>Inclusion :</u>&nbsp;Driver Allowance, Toll tax , State tax </p>
                                        <p class="mb-0 text-left"><u>Exclusion :</u>&nbsp;Parking charge , Airport Parking Charge</p>
                                    </div>
                                </div>
                        ...
                        <div class="modal pg-show-modal fade" id="modal2">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="mt-0 text-left"><u>Extra KM Charges :</u>&nbsp;12 ₹ Per KM</p>
                                        <p class="text-left"><u>Inclusion :</u>&nbsp;Driver Allowance, Toll tax , State tax </p>
                                        <p class="mb-0 text-left"><u>Exclusion :</u>&nbsp;Parking charge , Airport Parking Charge</p>
                                    </div>
                                </div>
                        ...
                        <div class="modal pg-show-modal fade" id="modal2">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p class="mt-0 text-left"><u>Extra KM Charges :</u>&nbsp;14 ₹ Per KM</p>
                                        <p class="text-left"><u>Inclusion :</u>&nbsp;Driver Allowance, Toll tax , State tax </p>
                                        <p class="mb-0 text-left"><u>Exclusion :</u>&nbsp;Parking charge , Airport Parking Charge</p>
                                    </div>
                                </div>
