...
if(isset($_REQUEST['submit'])){
    ...
    $response= addBookingToCRM($_REQUEST, "/index.php?entryPoint=sendCorporateCar");
            ...
            <div class="container pb-4 pt-4">
                <div class="row"> 
                    <div class="col-lg-8 ml-auto mr-auto py-3"> 
                        <h2 class="font-weight-bold text-uppercase">Corporate Car Rental</h2> 
                        <p class="mb-5 text-secondary">Enter Your Details Below</p> 
                        <form id="corporate_form" name="corporate_form" action="corporate.php"> 
                            ...
                            <div class="form-group"> 
                                <input type="email" class="border border-1 form-control rounded-1" placeholder="Email Address" name="email" id="email"> 
                            </div>                             
                            <div class="form-group"> 
                                <input type="text" class="border border-1 form-control rounded-1" placeholder="Company" id="company" name="company"> 
                            </div>                             
                            <div class="form-group"> 
</div>                             
                            <button type="submit" class="btn btn-block btn-warning rounded-1 text-body text-uppercase" name="submit" id="submit">Submit</button>                             
                        </form>                         
                    </div>                     
                </div>
            </div>             
