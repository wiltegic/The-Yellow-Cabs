...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>About The Yellow Cabs</title>         
    ...
    <div class="container pb-4 pt-4"> 
        <div class="align-items-center  row"> 
            <div class="col-lg-6 me-auto pb-3 pt-3 text-center">
                <img src="images/15-Rideshare-driver-shutterstock_762617950.jpg"/> 
            </div>             
            <div class="col-lg-5 pb-3 pt-3"> 
                <h2 class="h6 mb-1 text-body">Our Story</h2> 
                <h3 class="fw-bold h2 mb-1"><b>About Us</b></h3>
