...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Udaipur Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Udaipur City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">In the southern part of Indian state of Rajasthan, Udaipur is a city situated 598 m above the sea level. It is the best place to holiday in Rajasthan. The mind- boggling city of Udaipur is a hub of lakes, magnificent palaces, rich cultural heritage and lip - smacking delicious cuisines.</p> 
                        <p class="fw-light h5 mb-4">Udaipur, no doubt will definitely rejuvenate your body and soul because multiple lakes adorn this city. For this particular reason, Udaipur is also known as &lsquo;Venice of the East&rsquo;. The lakes of Udaipur are a poetry of charm and enchantment which has been luring tourists for ages.</p>
                        <p class="fw-light h5 mb-4">Some lakes of Udaipur like Lake Pichola are even featured in Hollywood and Bollywood movies. Some lakes would take you to green fields and farms, narrow pathways, scenic villages.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Udaipur :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit the famous&nbsp;City Palace of Udaipur.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Do some water avtivity at&nbsp;Lake Pichola.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Vitness the rish history of Udaipur at&nbsp;Bagore ki Haveli.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Go to&nbsp;Fateh Sagar Lake to get the mesmrising view of the nature.<br></p>                                      
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
