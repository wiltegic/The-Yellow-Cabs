...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Mumbai Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Mumbai City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">Overlooking the blue expanse of the Arabian Sea, the city of stars, Mumbai is Maharashtra&rsquo;s sweetheart. Amidst its cosmopolitan crowd, there still exists a world that is connected with rich history that can undoubtedly, win every heart.</p> 
                        <p class="fw-light h5 mb-4">Right from the holy sites to often crowded beaches, from colourful bazaars to happening nightlife and from sky scrapers to high-end hotels, Mumbai is filled with attractions that you cannot give a miss . The city is also a land of contrast that is adorned with colonial architecture on one side and houses one of Asia&rsquo;s biggest slums on the other side.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Mumbai :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Do take a leisurely stroll by the Arabian Sea, on Marine Drive.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ To witness the culinary richness of the city, Juhu Chowpatty is a must visit.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit Gateway of India which is the pride of India.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Good news shopaholics! Indulge in crazy shopping at chor bazaar, one of the most buzzing Mumbai markets.<br></p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Do visit Essel World- one of the most thrilling amusement parks in India.</p> 
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
