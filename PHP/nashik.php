...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Nashik Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    <div class="col-lg-6 me-auto pb-3 pt-3 text-center"> 
                        <img src="images/nasik.jpg"/> 
                    </div>                     
                    <div class="col-lg-6 pb-3 pt-3"> 
                        <h2 class="h6 mb-1 text-body">Explore</h2> 
                        <h3 class="fw-bold h2 mb-1"><b>Nashik City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">Recognized as one of the destinations for famous Kumbh Mela, Nashik is a must visit in the state of Maharashtra. An ancient city that has even found mention in the Hindu epics of Ramayana and Mahabharata, Nashik has so many aspects to show to its visitors apart from its religious one.</p> 
                        <p class="fw-light h5 mb-4">The city is also known for its lush vineyards that have a unique experience to impart. Nashik is rich in history, scenic landscape as well as architecture, all of which contribute to make it a holiday destination for everyone.</p>
                        <p class="fw-light h5 mb-4">Owing to the predominantly tropical climate in Nashik, the city is famous for its annual harvest of grapes, oranges and onions.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Nashik :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit Famous&nbsp;Anjaneri Hills of Nashik.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Enhance your spiritiuality at&nbsp;Muktidham Temple.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Get to know about history of money at&nbsp;Coin Museum of Nashik.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Do visit the very famous Sula Vineyard at the hillside of Nashik.<br></p>                                      
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
