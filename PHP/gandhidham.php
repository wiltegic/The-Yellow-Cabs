...
$city_id= get_city_id('Gandhidham');
...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Gandhidham Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    <div class="col-lg-6 me-auto pb-3 pt-3 text-center"> 
                        <img src="images/gandhidham.jpg"/> 
                    </div>                     
                    <div class="col-lg-6 pb-3 pt-3"> 
                        <h2 class="h6 mb-1 text-body">Explore</h2> 
                        <h3 class="fw-bold h2 mb-1"><b>Gandhidham City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">Owing to its historical significance, Gandhidham is an important city in the Kutch region. Once upon a time, Gandhidham was the refugee centre for homeless people coming from Sindh after 1947 partition.</p> 
                        <p class="fw-light h5 mb-4">Now, Gandhidham is a fast growing town with several manufacturing units in and around. The town of Gandhidham has a unique cosmopolitan population since the residents belong to different parts of India. Kandla Port, a major port on the west coast, is also a part of the Gandhidham region.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Gandhidham :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit&nbsp;The Bhadreshwar temple (32 kms from Gandhidham) is one of the most ancient Jain temples and the most visited Jain Pilgrim centres in Kutch.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit&nbsp;Kandla Port, which is one of the 8 major ports of India</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Go to see Poorneshwar Temple which is an ancient temple known for its unique architecture. Historians say that the temple was raised between 9th and 10th century..</p>                                                                           
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
