...
<html lang="en"> 
    <head> 
        ...
        <!-- site metas -->         
        <title>Indore Cab Booking</title>         
            ...
            <div class="container pb-4 pt-0"> 
                <div class="align-items-center  row"> 
                    ...
                    <div class="col-lg-6 pb-3 pt-3"> 
                        ...
                        <h3 class="fw-bold h2 mb-1"><b>Indore City&nbsp;</b></h3> 
                        <p class="fw-light h5 mb-4">One of the most popular and beautiful cities of Madhya Pardesh (MP), &apos;Indore&apos; has always fascinate its toutists with the charisma of its architectural magnificence and intriguing history.</p> 
                        <p class="fw-light h5 mb-4">It has been a home to various historical monuments and religious places, built by the great Maharashtrian rulers &apos;Holkar&apos; who ruled the city for several years.</p>
                        <p class="fw-light h5 mb-4">The rich cultural heritage of Indore makes it one of the most revered destintion in MP, which has a lot to offer to the people who come here on holiday tours. Your holidays in Indore can be exciting and wonderful if you visit its magnificent palaces, beautifully carved temples, and ancient forts.</p> 
                    </div>                     
                </div>                 
                <section class="bg-light pb-2 pt-2 text-center text-lg-left"> 
                    <div class="container pb-4 pt-4"> 
                        <div class="align-items-center row"> 
                            <div class="col-lg-12 "> 
                                <div class="pb-3 pt-3"> 
                                    <h3 class="font-weight-bold h4 text-left">Things to Do in Indore :</h3> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Visit the most popular attraction of Indore, the &lsquo;Rajwada,&rsquo; which is the historical palace of the holkars, built almost two centuries ago, located in the center of the city.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Another prime attraction of the city, the &lsquo;Lal Baag Palace&rsquo; is one of the most spectacular buildings in Indore, which you must definitely visit during your trip to Indore.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Go for a shopping to Sitlamata Bazaar, which is popular for Maheshwari and Chanderi Saris.</p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Enjoy a pleasant night at the Gandhi hall in Indore to watch a classical musical concert.<br></p> 
                                    <p class="h5 mb-0 text-body text-left">⦿ Rejuvenate your energy levels by visiting Tinchafaal waterfall, located a few kilometers away from the city.</p> 
                                </div>                                 
                            </div>                             
                        </div>                         
                    </div>                     
